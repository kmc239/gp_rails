...
ActiveRecord::Schema.define(:version => 20121127054956) do
  ...
  add_index "app_users", ["first_name"], :name => "index_app_users_on_first_name"
  add_index "app_users", ["last_name"], :name => "index_app_users_on_last_name"
